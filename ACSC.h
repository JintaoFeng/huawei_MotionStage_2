...
// For compilation targets 32-bit ARM, 64-bit ARM, x86, or x64
#include <windows.h>
#include <Winsock.h>
#include <comdef.h>

#elif defined(_WIN32) && defined(UNDER_RTSS)
// RTX
#include <windows.h>
#include <rtapi.h>
#endif
...
// function type definitions
	...
	static int InitACSCLibrary()
	{
		...
		acsc_GetEthernetCards = (ACSC_GetEthernetCards)GetProcAddress(hACSCLibraryModule, "_acsc_GetEthernetCards");											//	   228
